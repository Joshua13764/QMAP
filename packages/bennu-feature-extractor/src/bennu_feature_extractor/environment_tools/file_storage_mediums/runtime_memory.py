...
from bennu_feature_extractor.environment_tools.base_classes.fs_persist_base import \
...
class RuntimeMemory(FileStorageMediumBase):
    ...
    def save(self, obj: Any, virtual_path: Path,
             persist: FileStoragePersistBase) -> None:
