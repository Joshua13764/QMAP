...
class DetectionBoundingBoxExtract(TaskStepBase, StepDefaultMarkers):
    run_path: str
    result_output_path: str

    @property
    def hashable(self) -> tuple[Any, ...]:
        return self.include_markers_in_hashable(self.run_path, self.marker_to_merge, self.output_marker,
