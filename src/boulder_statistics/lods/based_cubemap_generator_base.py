...
@dataclass
class FSBasedCubemapGeneratorBase[T](
        CubemapGeneratorBase[Dict[CubemapLodPosition, FSPathLocalDisk], T]):

    def get_tile_path(
            self, cubemap_tile: CubemapLodPosition) -> FSPathLocalDisk:
        return self.generator_input[cubemap_tile]
